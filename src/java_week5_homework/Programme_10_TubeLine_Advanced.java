...
public class Programme_10_TubeLine_Advanced {
    public static void main(String[] args) {
        ...
        String station[] = ("Aldgate,Angel,Baker Street,Bank,Barbican,Bayswater,Blackfriers,Bond Street," +
                "Borough,Cannon Street,Chancery Lane,Charing Cross,Covent Garden,Earl's Court," +
                "Edgware Road,Elephant & Castle,Embarkment,Euston,Euston Square," +
                "Farrington,Gloucester Road,Goodgs Street,Great Portland Street,Green Park").split(",");
        ...
        do {
            ...
            if (str.equalsIgnoreCase(c)) {
                ...
                System.out.println("----------------------------------------------------");
                //Two for loop used for multidimesional array
                ...
                System.out.println(str + " Stations is not in zone 1 or your station name is wrong");
            }
