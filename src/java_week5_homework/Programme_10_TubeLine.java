...
public class Programme_10_TubeLine {
    public static void main(String[] args) {
        ...
        String[] tubeStationZone1 = new String[]{"Aldgate", "Aldgate East", "Angel", "BakerStreet", "Bank", "Barbican", "Bayswater", "Blackfriars",
        ...
        System.out.println("Please Enter tube station's name of Zone 1");
        ...
        if (userTubeStation.equalsIgnoreCase(catchStationName)) {
            ...
            for (int x = 0; x < londonUGLines.length; x++) {
                for (int y = 1; y < tubeStationZone1.length; y++) {
                    ...
                    //System.out.println("I am here line: 176"+match); //debug purpose
